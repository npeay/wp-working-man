 ...
 * @subpackage Wp_Working_Man/admin/partials
 */
?>
...
<!-- This file should primarily consist of HTML with a little bit of PHP. -->
	<div class="wrap">
			...
			<h2 class="nav-tab-wrapper"><?php _e('Login customization', $this->plugin_name);?></h2>
				...
				<!-- add your logo to login -->
					<fieldset>
						...
						<div id="upload_logo_preview" class="wp_wm-upload-preview <?php if(empty($login_logo_id)) echo 'hidden'?>">
							<img src="<?php echo $login_logo_url; ?>" />
							<button id="wp_wm-delete_logo_button" class="wp_wm-delete-image">X</button>
						</div>
					</fieldset>

				<!-- login background color-->
					<fieldset class="wp_wm-admin-colors">
		...
		<?php 	$login_logo = wp_get_attachment_image_src( $login_logo_id, 'thumbnail' );
				$login_logo_url = $login_logo[0]; ?>
